  ...
  function create_threeCompositeObjects(){
    for (let i=0; i<_maxFaces; ++i){
      ...
      if (_settings.isDebugPivotPoint){
        ...
        console.log('DEBUG in Helper: set the position of <pivot> in the console and report the value into ThreejsHelper.js for _settings.pivotOffsetYZ');
      }
    }
  }
    ...
    apply_videoTexture: function(threeMesh){
      ...
      threeMesh.onAfterRender = function(){
        ...
        try {
          ...
          console.log('WARNING in THREE.Helper : the glVideoTexture is not fully initialized');
        }
