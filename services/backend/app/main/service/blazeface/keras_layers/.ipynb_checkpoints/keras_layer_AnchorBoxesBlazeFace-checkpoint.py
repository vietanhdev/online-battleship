    ...
    def call(self, x, mask=None):
        ...
        if (self.this_offsets is None):
            ...
            if isinstance(self.this_offsets, (list, tuple)) and (len(self.this_offsets) == 2):
                offset_height = int(self.this_offsets[0])
                offset_width = int(self.this_offsets[1])
            elif isinstance(self.this_offsets, (int, float)):
                offset_height = int(self.this_offsets)
                offset_width = int(self.this_offsets)
        ...
        cy = np.linspace(offset_height * step_height, (offset_height + feature_map_height - 1) * step_height, feature_map_height, dtype=int)
        cx = np.linspace(offset_width * step_width, (offset_width + feature_map_width - 1) * step_width, feature_map_width, dtype=int)
