...
class SSDLoss:
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        pos_class_loss = tf.reduce_sum(input_tensor=classification_loss * positives, axis=-1) # Tensor of shape (batch_size,)
        ...
        neg_class_loss = tf.cond(pred=tf.equal(n_neg_losses, tf.constant(0)), true_fn=f1, false_fn=f2)
